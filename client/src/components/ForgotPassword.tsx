...
const ForgotPassword = () => {
  ...
  return (
    <div className='bg-white flex flex-col px-8 py-10 rounded-md w-[94%] max-w-[400px]'>
      <form className='flex flex-col' onSubmit={handleEmailSubmit}>
        <h1 className='text-center text-2xl font-bold mb-8'>Reset Password</h1>
        <input
          type='text'
        ...
        />
        <button
          className={`bg-[#009577] mb-8 rounded-md h-14 text-white md:text-xl font-semibold ${
            showOTPInput && 'cursor-not-allowed bg-[#cccccc]'
          }`}
