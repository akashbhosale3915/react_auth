...
const Signup = () => {
  ...
  async function signup({
    ...
    try {
      ...
      const { data } = await axiosInstance.post('/users/new', userData);
  ...
  return (
    <form
      ...
      <h1 className='text-center text-5xl font-bold mb-8'>Signup</h1>
      <input
        type='text'
      ...
      <input
        ...
        className='border h-14 rounded-md indent-4 md:text-lg'
        name='phone'
      />
      <button
        className='bg-[#009577] my-8 rounded-md h-14 text-white md:text-xl font-semibold'
        disabled={loading}>
